...
xml.urlset "xmlns" => "http://www.sitemaps.org/schemas/sitemap/0.9" do
  ...
  sitemap.resources.each do |page|
      ...
      # throw :next_page unless page.url.end_with?('.slim')
      #
      ...
      throw :next_page if page.url.start_with?('/assets/')
      ...
      xml.url do
        xml.loc 'http://www.greatwaychinesemartialarts.com' + page.url   # TODO: possibly remove .html
